...
import med.voll.api.DTO.DadosAuthentication;
import med.voll.api.entity.Usuario;
import med.voll.api.service.security.DTO.DadosTokenJWT;
...
public class AuthenticationController {
    ...
    @PostMapping
    public ResponseEntity<Object> authenticateUser(@RequestBody @Valid DadosAuthentication dados) {
